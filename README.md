...
| `HudPosition`               | `BottomLeft` <br/> `AboveHotbarCentered` <br/> `AboveHotbarLeft` <br/> `BelowHotbarCentered` <br/> `BelowHotbarLeft` <br/> `Custom:<layoutMode>:<left>:<bottom>` | `AboveHotbarCentered` | The position where the HUD will be rendered. As reference: `Custom:Bottom:12:12` is equivalent to `BottomLeft`. Also, `Custom:Center:-363:140` is equivalent to `AboveHotbarLeft`                                                                               |
